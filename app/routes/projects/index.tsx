...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Projects - siliconharbour.dev" },
    { name: "description", content: "Community projects from St. John's tech scene" },
  ];
}
...
27-.762.436-1.19.536v9.12l4.307 4.986 4.308-4.986v-9.12c-.428-.1-.812-.267-1.19-.536-.354-.246-.64-.573-.834-.972-.185.373-.448.69-.778.93-.443.32-.973.49-1.513.49h-.012c-.54 0-1.07-.17-1.513-.49-.33-.24-.593-.557-.778-.93z"/>
                            </svg>
                          </span>
                        )}
                        {links.website && (
