...
We do reserve the right to say _no_, as the intent is for the content to be of high quality. See if you can maybe find some PMF before submitting your B2B SaaS ChatGPT wrapper.
...
I think opening this up to having a _light_ sponsorship system for curated relevant ads on the website, and inclusions in newsletters, is in the future of this website.
...
By the [Andrej Karpathy](https://x.com/karpathy/status/1886192184808149383?lang=en) definition, _I don't think so_, but since its mostly just a CRUD application, and I didn't want to spend a ton of time on it, or a ton of time maintaining it, OpenCode and Claude Opus 4.5 were indeed the tools that authored this site, in the hands of someone who could have built it without those tools, but its 2026 and CRUD is solved.
